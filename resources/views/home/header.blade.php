                ...
                <div class="header__nav">
                    <nav class="header__menu">
                        <ul>
                            ...
                            <li><a href="{{asset('assets')}}//car.html">Cars</a></li>
                            <li><a href="{{asset('assets')}}//blog.html">Blog</a></li>
                            <li><a href="#">Pages</a>
                                <ul class="dropdown">
                                    <li><a href="{{asset('assets')}}//about.html">About Us</a></li>
                                    <li><a href="{{asset('assets')}}//car-details.html">Car Details</a></li>
                                    <li><a href="{{asset('assets')}}//blog-details.html">Blog Details</a></li>
                                </ul>
                            </li>
                            <li><a href="{{asset('assets')}}/about.html">About</a></li>
